...
public class AssignmentService {
    ...
    private String generateParamValuesForStudent(String paramBoundsJson, String studentId) {
        try {
            // Seed random with studentId hashcode so parameters are reproducible for the same student
            ...
            // Generate randomized numbers within range rounded to 2 decimal places
