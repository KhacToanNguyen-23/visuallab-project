...
export const DEFAULT_PUBLIC_LABS: PublicLabItem[] = [
  // LỚP 10
  {
    ...
    title: 'Bài 6: Đo Tốc Độ Vật Chuyển Động Thẳng (3D)',
    subject: 'Vật lý',
    domain: 'Cơ Học & Động Học',
    grade: 'Lớp 10',
    difficulty: 'EASY',
    chapter: 'Chương 2: Động Học',
    description: 'Trang 28 SGK. Đo thời gian bi thép qua 2 cổng quang điện trên máng nghiêng 3D để tính tốc độ v trung bình và tức thời.',
    tags: ['GDPT 2018', 'SGK T28', '3D WebGL', 'Máng nghiêng', 'Cổng quang'],
